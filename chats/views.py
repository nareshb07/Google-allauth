...
def creator_profile(request, username):
    ...
    try:
        creator_obj1 = User.objects.get(username = username)
...
def my_profile(request):
    ...
    if user_obj.is_Creator:
        ...
        return render(request, 'my_profile.html', {'profile': creator_profile_obj})
...
def dashboard(request ):
    ...
    return render(request , "new_dashboard.html", {'dashboard_data' : dashboard_obj, 'average_rating': average_rating , 'total_amount': total_amount,'record_count': record_count })
